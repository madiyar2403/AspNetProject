namespace ProjectForDotNet.Migrations
{
    ...
    public partial class DataMigration : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Transports", "CategoryId", "dbo.Categories");
            DropForeignKey("dbo.Categories", "TypeId", "dbo.Types");
            ...
            DropIndex("dbo.Transports", new[] { "CategoryId" });
            DropIndex("dbo.Orders", new[] { "TransportId" });
            DropIndex("dbo.Categories", new[] { "TypeId" });
